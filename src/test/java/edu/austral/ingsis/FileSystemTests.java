...
public class FileSystemTests {
  ...
  private final FileSystemRunner runner = new FileSystemRunnerImpl(new CLI());
  ...
  void test3() {
    executeTest(
            List.of(
                    ...
                    entry("touch elizabeth.txt", "'elizabeth.txt' file created"),
                    entry("mkdir t-bone", "'t-bone' directory created"),
                    entry("touch elizabeth.txt", "'elizabeth.txt' already exists"),
                    entry("ls", "elizabeth.txt t-bone"),
                    entry("rm t-bone", "Use --recursive to remove a directory"),
